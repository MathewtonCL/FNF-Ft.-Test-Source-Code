...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		if (PlayState.bfMode == 'bf-test')
		{
			portraitRight = new FlxSprite(0, 40);
			portraitRight.frames = FlxAtlasFrames.fromSparrow('assets/images/weeb/plTestPortrait.png', 'assets/images/weeb/plTestPortrait.xml');
			portraitRight.animation.addByPrefix('enter', 'Test portrait enter', 24, false);
			portraitRight.setGraphicSize(Std.int(portraitRight.width * PlayState.daPixelZoom * 0.9));
			portraitRight.updateHitbox();
			portraitRight.scrollFactor.set();
			add(portraitRight);
		...
		if (PlayState.isTestMode == true)
		{
			portraitLeft = new FlxSprite(-20, 40);
			portraitLeft.frames = FlxAtlasFrames.fromSparrow('assets/images/weeb/opTestPortrait.png', 'assets/images/weeb/opTestPortrait.xml');
			portraitLeft.animation.addByPrefix('enter', 'Test Portrait Enter', 24, false);
			portraitLeft.setGraphicSize(Std.int(portraitLeft.width * PlayState.daPixelZoom * 0.9));
			portraitLeft.updateHitbox();
			portraitLeft.scrollFactor.set();
			add(portraitLeft);
		...
		if(PlayState.SONG.song.toLowerCase() == 'roses')
		{
			if(PlayState.isTestMode == true)
			{
				...
				box.frames = FlxAtlasFrames.fromSparrow('assets/images/weeb/pixelUI/dialogueBox-testMad.png',
					'assets/images/weeb/pixelUI/dialogueBox-testMad.xml');
				box.animation.addByPrefix('normalOpen', 'TEST ANGRY IMPACT SPEECH', 24, false);
				box.animation.addByIndices('normal', 'TEST ANGRY IMPACT SPEECH', [4], "", 24);
			}
			else
			{
				FlxG.sound.play('assets/sounds/ANGRY_TEXT_BOX' + TitleState.soundExt);
		...
		if (PlayState.SONG.song.toLowerCase() == 'thorns')
		{
			if(PlayState.isTestMode == true)
			{
				var face:FlxSprite = new FlxSprite(320, 170).loadGraphic('assets/images/weeb/testDeadpixelError.png');
				face.setGraphicSize(Std.int(face.width * 6));
				add(face);
			}
			else
