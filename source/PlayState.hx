...
class PlayState extends MusicBeatState
{
	...
	public static var testMode:String = '';
	public static var isTestMode:Bool = false;
	public static var normalMode:String = '';
	...
	override public function create()
	{
		...
		switch (SONG.song.toLowerCase())
		{
			...
			case 'senpai':
				dialogue = CoolUtil.coolTextFile('assets/data/senpai/ogSenpaiDialogue.txt');
			case 'roses':
				dialogue = CoolUtil.coolTextFile('assets/data/roses/ogRosesDialogue.txt');
			case 'thorns':
				dialogue = CoolUtil.coolTextFile('assets/data/thorns/ogThornsDialogue.txt');
		}
		...
		if (SONG.song.toLowerCase() == 'senpai')
		{
			if (isTestMode == true)
			{
				if (isTestStoryMode == true)
				{
					if (bfMode == 'bf')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/senpai/altDialogue/tbSenpaiDialogue.txt');
					}
					else if (bfMode == 'bf-test')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/senpai/altDialogue/ttSenpaiDialogue.txt');
					}
				}
			}
			else if (isStoryMode == true)
			{
				if (bfMode == 'bf-test')
				{
						dialogue = CoolUtil.coolTextFile('assets/data/senpai/altDialogue/stSenpaiDialogue.txt');
				}
			}
			else {
				dialogue = CoolUtil.coolTextFile('assets/data/senpai/ogSenpaiDialogue.txt');
		...
		if (SONG.song.toLowerCase() == 'roses')
		{
			if (isTestMode == true)
			{
				if (isTestStoryMode == true)
				{
					if (bfMode == 'bf')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/roses/altDialogue/tbRosesDialogue.txt');
					}
					else if (bfMode == 'bf-test')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/roses/altDialogue/ttRosesDialogue.txt');
					}
				}
			}
			else if (isStoryMode == true)
			{
				if (bfMode == 'bf-test')
				{
						dialogue = CoolUtil.coolTextFile('assets/data/roses/altDialogue/stRosesDialogue.txt');
				}
			}
			else {
				dialogue = CoolUtil.coolTextFile('assets/data/roses/ogRosesDialogue.txt');
		...
		if (SONG.song.toLowerCase() == 'thorns')
		{
			if (isTestMode == true)
			{
				if (isTestStoryMode == true)
				{
					if (bfMode == 'bf')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/thorns/altDialogue/tbThornsDialogue.txt');
					}
					else if (bfMode == 'bf-test')
					{
						dialogue = CoolUtil.coolTextFile('assets/data/thorns/altDialogue/ttThornsDialogue.txt');
					}
				}
			}
			else if (isStoryMode == true)
			{
				if (bfMode == 'bf-test')
				{
						dialogue = CoolUtil.coolTextFile('assets/data/thorns/altDialogue/stThornsDialogue.txt');
				}
			}
			else {
				dialogue = CoolUtil.coolTextFile('assets/data/thorns/ogThornsDialogue.txt');
		...
		else if (SONG.song.toLowerCase() == 'test')
		{
			defaultCamZoom = 0.9;
			curStage = 'demoblock';
			var bg:FlxSprite = new FlxSprite(-600, -300).loadGraphic('assets/images/demoblock.png');
			bg.antialiasing = true;
		...
		//DING DONG THE CODE IS DEAD!! (...hopefully)
		//hold up, new (old) stuff

		boyfriend = new Boyfriend(770, 450, bfMode+dumbassSuffix);
		trace('LOADED BOYFRIEND :'+ bfMode + dumbassSuffix);

		//DIFFERENT FREEPLAY TESTS
		if (isTestMode == true){
			var singerSuffix:String = '';

			switch (curStage){
			case 'limo':
			singerSuffix = '-car';
			case 'mall':
			singerSuffix = '-christmas';
			case 'mallEvil':
			singerSuffix = '-christmas-red';
			case 'school':
			singerSuffix = '-pixel';
			case 'schoolEvil':
			singerSuffix = '-deadpixel';
			default:
			singerSuffix = '';
			}

			dad = new Character(100, 100, testMode + singerSuffix);
			trace('LOADED TEST :'+ testMode + singerSuffix);
		}		
	...
	override public function update(elapsed:Float)
	{
		...
		iconP1.animation.play(bfMode + dumbassSuffix);
		trace('LOADED BOYFRIEND :'+ bfMode + dumbassSuffix);

		if (isTestMode == true){
			iconP2.animation.play(testMode);
		}
	...
	function endSong():Void
	{
		...
		if (isStoryMode || isTestStoryMode)
		{
